...
`AddonConfig` by label) to a gateway class it does provide — the override layer
is the cluster, same as AKO's own `disable-ako` toggle. Steps:
`docs/GETTING-STARTED.md` "Headlamp".
